...
import ui.SharedPreferenceUtil;

public class PracticeMain extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    TextView tvHello;
    TextView tvEmail;//header --> navigationView
    TextView tvUserName;//header --> navigationView
    ...
    void initView(){
        ...
        tvEmail = (TextView) navigationView.getHeaderView(0)
        ...
        String email = SharedPreferenceUtil.getString(this,"email","");

        tvHello.setText(getString(R.string.title,userName));
